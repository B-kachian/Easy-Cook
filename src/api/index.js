...
export const getRecipe = (id) => Promise.resolve(Object.values(recipes)
      .flat()
      .filter(i => i.id === id)
  );
...
export const doLogin = (email, password) =>
  ...
  new Promise((resolve, reject) => {
    const Correct='For Login the Correct email is    b.kachian@yahoo.com and password is   12345'
   
   
    if (email === "b.kachian@yahoo.com" && password === "12345") {
      resolve({ name: "Behnam Kachian", userId: "b.kachian" });
    } 
